...
// In your component decorator
  template: `
    <section>
      <h2 class="text-4xl font-bold font-main mb-3 text-neutral-900 dark:text-white">{{ t('resume.education.title') }}</h2>
      <p class="mb-7 text-neutral-700 dark:text-neutral-300">
