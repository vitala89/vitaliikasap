...
@Component({
  ...
  template: `
    <div
      class="top-4 right-8 z-50 p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-offset-2 bg-white dark:bg-gray-800 text-gray-700 dark:text-yellow-400 focus:ring-blue-500 dark:focus:ring-yellow-400">
      <svg
        [attr.width]="size"
        [attr.height]="size"
        viewBox="0 0 676 761"
        class="cursor-hover w-full h-full"
        fill="none"
        ...
        <defs>
          <linearGradient id="logo-gradient" x1="0" y1="0" x2="1" y2="1">
            ...
            <stop offset="100%" stop-color="#8b5cf6">
              <animate attributeName="stop-color" values="#8b5cf6;#6366f1;#8b5cf6" dur="2s" repeatCount="indefinite"/>
            </stop>
          </linearGradient>
        </defs>
        <g transform="translate(0.000000,761.000000) scale(0.100000,-0.100000)"
           [attr.fill]="useGradient ? 'url(#logo-gradient)' : 'currentColor'" stroke="none"
...
export class LogoComponent {
  ...
  /** true = animated gradient, false = tailwind currentColor */
